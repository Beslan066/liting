...
@section('content')
    <div class="entry-header entry-header-style-2 pb-80 pt-80 mb-50 text-white" style="background-image: url(assets/imgs/news/news-20.jpg)">
    ...
    <section class="newsletter bg-brand-3 pt-100 pb-100">
        <div class="container">
            <div class="position-relative">
                ...
                <img src="assets/imgs/theme/sketch-1.png" alt="" class="sketch-1 wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
            </div>
        </div>
    </section>
@endsection
