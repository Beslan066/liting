        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-30">
                    <img class="mb-30" src="assets/imgs/authors/about-1.png" alt="">
                    <h5>Leo Messi</h5>
                ...
                <div class="col-lg-3 col-md-6 mb-md-30">
                    <img class="mb-30" src="assets/imgs/authors/about-2.png" alt="">
                    <h5>Ana Missar</h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-md-30">
                    <img class="mb-30" src="assets/imgs/authors/about-3.png" alt="">
                    <h5>Ken Adison</h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-md-30">
                    <img class="mb-30" src="assets/imgs/authors/about-4.png" alt="">
                    <h5>Lemon Trea</h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-md-30">
                    <img class="mb-30" src="assets/imgs/authors/about-5.png" alt="">
                    <h5>Elon Musk</h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-md-30">
                    <img class="mb-30" src="assets/imgs/authors/about-6.png" alt="">
                    <h5>Larry Page</h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-md-30">
                    <img class="mb-30" src="assets/imgs/authors/about-7.png" alt="">
                    <h5>Bill Gates</h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
                <div class="col-lg-3 col-md-6">
                    <img class="mb-30" src="assets/imgs/authors/about-8.png" alt="">
                    <h5>Bernard </h5>
                    <p class="font-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, fuga esse quibusdam dolor veritatis similique sin</p>
                </div>
            </div>
