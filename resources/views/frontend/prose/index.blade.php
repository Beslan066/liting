        ...
        <div class="container">
            <div class="row">
                <div class="header-title mb-65">
                    <h3 class="font-heading mb-0 wow fadeIn   animated" style="visibility: visible; animation-name: fadeIn; ">Проза</h3>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="post-thumb thumb-overlay img-hover-slide position-relative"
                                             @if(isset($prose->image))style="background-image: url({{asset('storage/public/' . $prose->image)}})"
                                            @endif>
                                    ...
                                    <div class="col-md-7 align-self-center">
                                        <div class="post-content pr-30">
                                            <h3 class="post-title mb-40">
                                                <a class="" href="">{{$prose->name}}</a>
                                            </h3>
                                            <div class="d-flex">
                                                <div class="post-meta-2 font-md d-flex w-70">
                                                    <a class="align-self-center" href="page-author.html" tabindex="0">
                                                        <img src="{{asset('storage/public/' . $prose->author->image)}}" alt="">
                                                    </a>
                                                    <div class="mb-0">
                                                        <a href="page-author.html" tabindex="0"> <strong class="author-namge">{{$prose->author->name}}</strong></a>
                                                        <p class="post-on font-sm text-grey-400 mb-0">{{$prose->created_at}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
