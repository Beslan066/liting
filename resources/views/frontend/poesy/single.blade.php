...
@section('content')
    <div class="entry-header entry-header-style-2 pb-80 pt-80 mb-50 text-white" style="background-image: url({{asset('storage/public/' . $poesy->image)}})">
        <div class="entry-header-content">
            <div class="post-meta-1 mb-20">
                ...
                <span class="post-date  text-white font-md">{{$poesy->created_at}}</span>
            </div>
