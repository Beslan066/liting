                    ...
                    <div class="table-responsive theme-scrollbar">
                        <div id="basic-9_wrapper" class="dataTables_wrapper">
                            <div id="basic-9_filter"
                                ...
                                <div>
                                    <a href="{{route('admin.play.create')}}" class="btn btn-outline-success" type="button" data-bs-original-title="" title="">Добавить</a>
                                </div>
                                ...
                                @if(isset($plays))
                                    @foreach($plays as $play)
                                        <tr role="row" >
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit"><a href="{{route('admin.play.edit', $play->id)}}" data-bs-original-title="" title=""><i
                                                                class="icon-pencil-alt"></i></a></li>
                                                    <li class="delete">
                                                        <form action="{{route('admin.play.delete', $play->id)}}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit"
