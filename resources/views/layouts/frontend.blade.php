...
<head>
    ...
    <title>Журнал "Литературная Ингушетия"</title>
...
<aside id="sidebar-wrapper" class="custom-scrollbar offcanvas-sidebar">
    <button class="off-canvas-close"><img class="svg-icon-24" src="{{asset('frontend/assets/imgs/theme/svg/close.svg')}}" alt=""></button>
    <div class="sidebar-inner">
        <div class="sidebar-widget widget-creative-menu">
            <ul>
                <li><a href="">Design<sup>235</sup></a></li>
                <li><a href="">Lifestyle<sup>186</sup></a></li>
                <li><a href="">Travel Tips<sup>98</sup></a></li>
            ...
            <div class="header-style-1">
                ...
                <div class="main-nav d-none d-lg-block">
                    <nav>
                        ...
                        <ul class="main-menu d-none d-lg-inline">
                            <li> <a href="{{route('frontend.poesy.index')}}">Поэзия</a> </li>
                            <li> <a href="{{route('frontend.prose.index')}}">Проза</a> </li>
                            <li> <a href="{{route('frontend.plays.index')}}">Пьесы</a> </li>
                            <li> <a href="{{route('frontend.jubilees.index')}}">Юбилеи</a> </li>
                            <li> <a href="{{route('frontend.authors')}}">Авторы</a> </li>
                            <li> <a href="{{route('frontend.archive')}}">Архив</a> </li>
                            <li> <a href="{{route('frontend.about')}}">О нас</a> </li>
                ...
                <div class="header-right">
                    <button class="search-icon d-md-inline">
                        <img src="{{asset('frontend/assets/imgs/theme/svg/search.svg')}}" alt="">
                    </button>
                </div>
            </div>
                        ...
                        <div class="input-group w-100">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-search bg-white" type="submit">
                                    <img class="svg-icon-24" src="{{asset('frontend/assets/imgs/theme/svg/search.svg')}}" alt="">
                                </button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="row bottom-area-2">
            <div class="col-lg-4 col-md-6">
                <div class="sidebar-widget widget-about wow fadeIn animated mb-30">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">Контакты</h5>
                    </div>
                    <div class="textwidget">

                        <p><strong>Главный редактор: ...</strong></p>
                        <p><strong class="color-black">Адрес</strong><br>
                            86101, Республика Ингушетия, г. Назрань, тер. Центральный округ, пр. И. Базоркина, д. 60.</p>
                        <p><strong class="color-black">Телефон</strong><br>
                            (+01) 234 567 89</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="sidebar-widget widget_categories wow fadeIn animated mb-30" data-wow-delay="0.1s">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">Лицензии</h5>
                    </div>
                    <ul class="font-small">
                        <p></p>
                        <p></p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="sidebar-widget widget_categories wow fadeIn animated mb-30" data-wow-delay="0.1s">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">Другие страницы</h5>
                    </div>
                    <ul class="font-small">
                        <li class="cat-item cat-item-2"><a href="#">О нас</a></li>
                        <li class="cat-item cat-item-4"><a href="#">Контакты</a></li>
                        <li class="cat-item cat-item-5"><a href="#">Правила использования материалов</a></li>
                        <li class="cat-item cat-item-6"><a href="#">Согласие на обработку персональных данных</a></li>
                    </ul>
                </div>
            </div>
