                ...
                <nav class="sidebar-main">
                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list"><a
                                    class="sidebar-link sidebar-title" href="{{route('admin.poesies.index')}}"><span><i
                                            data-feather="calendar"></i>Поэзия</span></a>
                            </li>

                            <li class="sidebar-list"><a
                                    class="sidebar-link sidebar-title" href="{{route('admin.play.index')}}"><i
                                        data-feather="list"></i><span>Пьесы</span></a>
                            </li>
                            <li class="sidebar-list"><a
                                    class="sidebar-link sidebar-title" href="{{route('admin.proses.index')}}"><i
                                        data-feather="users"></i><span>Проза</span></a>
                            </li>
                            <li class="sidebar-list"><a
                                    class="sidebar-link sidebar-title" href="{{route('admin.jubilees.index')}}"><i
                                        data-feather="calendar"></i><span>Юбилеи</span></a>
                            </li>
                            <li class="sidebar-list"><a
                                    class="sidebar-link sidebar-title" href=""><i
                            ...
                            <li class="sidebar-list"><a
                                    class="sidebar-link sidebar-title link-nav" href="{{route('admin.authors.index')}}"><i
                                        data-feather="user"> </i><span>Авторы</span></a></li>
