...
$(document).ready(function () {
    ...
    // Удаляем обработчики для темной темы
    /*
    ...
    */
    ...
    // Удаляем обработчики для темной темы и mix layout
    /*
    $(".customizer-color.dark li").on('click', function () {
        $(".customizer-color.dark li").removeClass('active');
        $(this).addClass("active");
    ...
    */
    ...
    // Заменяем обработчик mix layout чтобы всегда была светлая тема
    $(".customizer-mix li").on('click', function () {
        $(".customizer-mix li").removeClass('active');
        $(this).addClass("active");
        // Принудительно устанавливаем светлую тему вместо выбранной
        $("body").removeClass("dark-only").addClass("light-only");
        localStorage.removeItem("dark");
    });
    ...
    // Принудительно устанавливаем светлую тему при загрузке
    $("body").removeClass("dark-only").addClass("light-only");
    localStorage.removeItem("dark");
});
